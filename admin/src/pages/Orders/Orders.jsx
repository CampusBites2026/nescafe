...
// =============================================
const socket = io("https://nescafe-kgpq.onrender.com", { autoConnect: true });
...
const Orders = () => {
  ...
  const API_BASE = "https://nescafe-kgpq.onrender.com";
  ...
  const generateUPILink = (order) => {
    const upiId = "Payment request from MADHUR AGARWAL agarwalmadhur532@okicici";
